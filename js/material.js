function ShaderProgram (gl, vertSrc, fragSrc) {
  ...
  this.diffuseColor = gl.getUniformLocation(program, 'diffuseColor');
  this.specularColor = gl.getUniformLocation(program, 'specularColor');
  this.emission = gl.getUniformLocation(program, 'emission');
  this.shininess = gl.getUniformLocation(program, 'shininess');
  this.group = gl.getUniformLocation(program, 'group');
  ...
  this.lightsOn = gl.getUniformLocation(program, 'lightsOn')

  this.diffuse = gl.getUniformLocation(program, 'diffuse')
  this.mytime = gl.getUniformLocation(program, 'mytime')
  this.vert = vert
  this.frag = frag
